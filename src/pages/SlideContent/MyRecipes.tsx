  ...
  return (
    <div className="my-recipe-container">
      <div className="my-recipe-dropdown">
        <button
          className={`my-recipe-dropdown-btn ${
            sortOption === "기본" ? "default" : "active"
          }`}
          ...
          <div key={recipe.id} className="recipe-card">
            <div className="recipe-header">
              ...
              <div className="views-likes-container">
                <img src="/image/eye.png" alt="조회수" />
                {recipe.views}
                <img src="/image/saveIcon.png" alt="저장수" />
                {recipe.likes}
              </div>
            </div>
              ...
              <div className="recipe-details">
                <span className="feature1">
                  <div className="feature-circle">
                    <img src="\image\water_drop.png" alt="물방울 이미지"></img>
                    재료 {recipe.ingredientsCount}개
                  </div>
                </span>
                <span className="feature2">
                  <div className="feature-circle">
                    <img src="\image\Clock.png" alt="시계 이미지"></img>
                    {recipe.stepsCount}단계
                  </div>
                </span>
                <span className="feature3">
                  <div className="feature-circle">
                    <img src="\image\local_bar.png" alt="칵테일 이미지"></img>
                    도수 {recipe.alcoholContent}
                  </div>
                </span>
              </div>
