        ...
        <div className={`taste-note-container ${deleteTarget ? "blurred" : ""}`}>
            <header>
                ...
                <div className="taste-note-dropdown">
                    ...
                    <ul className={`taste-note-dropdown-menu ${isOpen ? "open" : ""}`} style={{ display: isOpen ? "block" : "none" }}>
                        <li className="selected-option">{selectedOption === "recent" ? "최근 작성순" : "평점순"}</li>
                        {["recent", "rating"]
            ...
            <div className="taste-note-drink-list">
                ...
                {sortedDrinks.length > 0 ? (
                    sortedDrinks.map((drink) => (
                        <div key={drink.id} className="taste-note-drink-item" onClick={() => {
                            setEditTarget(drink);
                            ...
                            <div className="taste-note-drink-hover-container">
                                ...
                                <button className="taste-note-delete-button" onClick={(e) => {
