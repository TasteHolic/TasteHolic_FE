        ...
        <div className="picking-container">
          ...
          <div className="pick-content">
            ...
            <p className="drink-description">
              {drinks[currentDrink].description}
            </p>
