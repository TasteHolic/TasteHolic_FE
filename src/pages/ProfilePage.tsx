...
const dummyProfiles = [
    { nickname: "WhiskyLover", introText: "칵테일을 아주아주아주 좋아합니다.", profileImage: "/image/basicimage.png" },
    { nickname: "CocktailMaster", introText: "칵테일 마스터입니다.", profileImage: "/image/basicimage.png" },
    { nickname: "WineTaster", introText: "와인의 향을 즐깁니다.", profileImage: "/image/basicimage.png" }
];
...
const ProfilePage: React.FC = () => {
    ...
    const [profileImage, setProfileImage] = useState<string>(randomProfile.profileImage);
    ...
    useEffect(() => {
        ...
        const storedNickname = localStorage.getItem("nickname") || randomProfile.nickname;
        const storedIntro = localStorage.getItem("introText") || randomProfile.introText;
        const storedProfileImage = localStorage.getItem("profileImage") || randomProfile.profileImage;
                ...
                {isLogoutModalOpen && (
                    <div className="profile-page-modal-overlay">
                        <div className="profile-page-modal-content">
                            <p className="profile-page-modal-text">정말 로그아웃 하시겠습니까?</p>
                            <div className="profile-page-modal-actions">
                                <button onClick={() => setLogoutModalOpen(false)} className="profile-page-cancel-btn">닫기</button>
                                <button onClick={handleLogout} className="profile-page-confirm-btn">로그아웃</button>
                            </div>
                        </div>
                    </div>
                )}
