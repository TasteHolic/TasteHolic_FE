...
const dummyProfiles = [
  {
    ...
    profilePic: "/image/basicimage.png",
  },
  {
    userId: "CocktailMaster",
...
const ProfilePage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const storedProfilePic =
      localStorage.getItem("profilePic") || randomProfile.profilePic;
        ...
        <div className="profile-header">
          <div className="profile-container">
            <div className="profile-picture">
              <img
                src={profilePic || "/image/basicimage.png"}
                alt="프로필 사진"
              />
            </div>
